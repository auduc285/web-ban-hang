    ...
    <div class="manager">
        ...
        <div class="manager__body">
            ...
            <table class="staff__body-table">
                ...
                <tr>
                    <td>1</td>
                    <td>Nguyễn Tuấn Mạnh</td>
                    <td>0867785373</td>
                    <td>manh28@gmail.com</td>
                    <td>
                        <a href="./edit-customer.html" title="Sửa" class="staff__body-table-link">
                            <i class="staff__body-table--icon fa-solid fa-pen"></i>
                        </a>
                        <a href="" title="Xóa" class="staff__body-table-link">
                            <i class="staff__body-table--icon fa-solid fa-trash"></i>
                        </a>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>Tạ Ngọc Tú</td>
                    <td>0867785373</td>
                    <td>tuta18@gmail.com</td>
                    <td>
                        <a href="./edit-customer.html" class="staff__body-table-link">
