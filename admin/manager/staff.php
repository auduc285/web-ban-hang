    ...
    <div class="manager">
        ...
        <div class="manager__body">
            ...
            <div class="staff__body-add">
                <a href="./add-staff.php" title="Thêm" class="staff__body-add-link">
            ...
            <table class="staff__body-table">
                ...
                <tr>
                    ...
                    <td><?php echo $each['sex'] ?></td>
                    <td><?php echo $each['date'] ?></td>
                    <td><?php echo $each['adress'] ?></td>
                    <td><?php echo $each['phone'] ?></td>
                    <td><?php echo $each['email'] ?></td>
                    <td>
                        <a href="./edit-staff.php?id=<?php echo $each['ID'] ?>" class="staff__body-table-link">
                            <i title="Sửa" class="staff__body-table--icon fa-solid fa-pen"></i>
                        </a>
                        <a href="./delete-staff.php?id=<?php echo $each['ID'] ?>" title="Xóa" class="staff__body-table-link">
