    ...
    <div class="manager">
        ...
        <ul class="manager__nav">
            ...
            <li class="manager__nav-item manager__nav-item--now">
                <a href="./slide.html" class="manager__nav-item-link manager__nav-item--now">
        ...
        <div class="manager__body">
            ...
            <div class="staff__body-add">
                <a href="./add-slide.html" title="Thêm" class="staff__body-add-link">
            ...
            <table class="staff__body-table">
                ...
                <tr>
                    <td>1</td>
                    <td>
                        <img src="../assets/img/slide1.jpg" alt="" width="100%">
                    </td>
                    <td>
                        <a href="./edit-slide.html" class="staff__body-table-link">
                ...
                <tr>
                    <td>2</td>
                    <td>
                        <img src="../assets/img/slide2.jpg" alt="" width="100%">
                    </td>
                    <td>
                        <a href="./edit-slide.html" class="staff__body-table-link">
                            <i title="Sửa" class="staff__body-table--icon fa-solid fa-pen"></i>
