        ...
        <div class="manager__body">
            ...
            <div class="add-staff_body-a">
                <form action="" class="add-staff__body">
                    <h3 class="add-staff__body-title">Sửa Nhân Viên</h3>
                    <div class="add-staff__body-item">
                        <span class="add-staff__body-item-text">Họ Và Tên</span>
                        <input type="text" value="Hồ Sỹ Mạnh" placeholder="Họ Và Tên" class="add-staff__body-item-inp" required>
                    </div>
                    <div class="add-staff__body-item">
                        <span class="add-staff__body-item-text">Ảnh Cũ</span>
                        <img src="../assets/img/manh.png" alt="" class="add-staff__body-img-old">
                    </div>  
                    <div class="add-staff__body-item">
                    ...
                    <div class="add-staff__body-item">
                        ...
                        <input type="date" class="add-staff__body-item-inp" required>
                    </div>
                    <div class="add-staff__body-item">
                        <span class="add-staff__body-item-text">Địa Chỉ</span>
                        <input type="text" value="Tân Long, Tân Kỳ, Nghệ AN" placeholder="Địa Chỉ" class="add-staff__body-item-inp" required>
                    </div>
                    <div class="add-staff__body-item">
                        <span class="add-staff__body-item-text">Số Điện Thoại</span>
                        <input type="number" value="0867785373" placeholder="Số Điện Thoại" class="add-staff__body-item-inp" required>
                    </div>
                    <div class="add-staff__body-item">
                        <span class="add-staff__body-item-text">Email</span>
                        <input type="email" value="homanh28@gmail.com" placeholder="Email" class="add-staff__body-item-inp" required>
                    </div>
