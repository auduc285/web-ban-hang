    ...
    <div class="manager">
        ...
        <div class="manager__body">
            ...
            <div class="add-staff_body-a">
                <form action="process__edit_staff.php" method="post" class="add-staff__body" enctype="multipart/form-data">
                    ...
                    <div class="add-staff__body-item">
                        ...
                        <input type="text" name="date" placeholder="yyyy-mm-dd" value="<?php echo $each['date'] ?>" class="add-staff__body-item-inp" required>
                    </div>
                    <div class="add-staff__body-item">
