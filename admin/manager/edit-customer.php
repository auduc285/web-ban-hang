    ...
    <div class="manager">
        ...
        <ul class="manager__nav">
            ...
            <li class="manager__nav-item manager__nav-item--now">
                <a href="./customer.html" class="manager__nav-item-link manager__nav-item--now">
            ...
            <div class="add-staff_body-a">
                <form action="" class="add-staff__body">
                    ...
                    <div class="add-staff__body-item">
                        ...
                        <input type="email" value="tuanmanh@gmail.com" placeholder="Email" class="add-staff__body-item-inp" required>
                    </div>
