    ...
    <div class="manager">
        ...
        <ul class="manager__nav">
            ...
            <li class="manager__nav-item manager__nav-item--now">
                <a href="./bell.html" class="manager__nav-item-link manager__nav-item--now">
        ...
        <div class="manager__body">
            ...
            <div class="staff__body-add">
                <a href="./add-bell.html" title="Thêm" class="staff__body-add-link">
            ...
            <table class="staff__body-table">
                ...
                <tr>
                    <td>1</td>
                    <td>
                        <img src="../assets/img/slae1k.png" alt="" height="100px" width="100px">
                    </td>
                    <td>Sale 1K</td>
                    <td>
                        <a href="./edit-bell.html" class="staff__body-table-link">
