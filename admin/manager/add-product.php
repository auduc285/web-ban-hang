            ...
            <div class="add-staff_body-a">
                <form action="" class="add-staff__body">
                    ...
                    <div class="add-staff__body-item">
                        ...
                        <input type="text" placeholder="Tên Sản Phẩm" class="add-staff__body-item-inp">
                    </div>  
                    <div class="add-staff__body-item">
                    ...
                    <div class="add-staff__body-item">
                        ...
                        <input type="number" placeholder="Giá" class="add-staff__body-item-inp">
                    </div>
                    <div class="add-staff__body-item">
                        <span class="add-staff__body-item-text">Mô Tả Sản Phẩm</span>
                        <textarea name="" id="" placeholder="Mô Tả" class="add-staff__body-item-inp" cols="30" rows="10"></textarea>
                    </div>
