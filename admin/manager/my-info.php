...
<body>
    <div class="manager">
        ...
        <ul class="manager__nav">
            ...
            <li class="manager__nav-item">
                <a href="" class="manager__nav-item-link">
            ...
            <div class="add-staff_body-a">
                <form action="" class="add-staff__body">
                    ...
                    <div class="add-staff__body-item">
                        ...
                        <input type="text" value="Âu Quang Đức" placeholder="Họ Và Tên" class="add-staff__body-item-inp" required>
                    </div>
                    <div class="add-staff__body-item">
                        <span class="add-staff__body-item-text">Ảnh Cũ</span>
                        <img src="../assets/img/84332788_192794961797534_7049027482996965376_n.jpg" alt="" class="add-staff__body-img-old">
                    </div>  
                    <div class="add-staff__body-item">
                    ...
                    <div class="add-staff__body-item">
                        ...
                        <input type="number" value="0379521705" placeholder="Số Điện Thoại" class="add-staff__body-item-inp" required>
                    </div>
