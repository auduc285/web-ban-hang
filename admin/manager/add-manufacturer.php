    ...
    <div class="manager">
        ...
        <ul class="manager__nav">
            ...
            <li class="manager__nav-item manager__nav-item--now">
                <a href="./manufacturer.html" class="manager__nav-item-link manager__nav-item--now">
        ...
        <div class="manager__body">
            ...
            <div class="add-staff_body-a">
                <form action="" class="add-staff__body">
                    <h3 class="add-staff__body-title">Thêm Nhà Sản Xuât</h3>
                    <div class="add-staff__body-item">
                        <span class="add-staff__body-item-text">Tên Nhà Sản Xuất</span>
                        <input type="text" placeholder="Tên Nhà Sản Xuất" class="add-staff__body-item-inp">
                    </div>  
