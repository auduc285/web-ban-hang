        ...
        <div class="manager__body">
            ...
            <table class="staff__body-table">
                ...
                <tr>
                    ...
                    <td>
                        <a href="./edit-customer.php?id=<?php echo $each['ID'] ?>" title="Sửa" class="staff__body-table-link">
                            <i class="staff__body-table--icon fa-solid fa-pen"></i>
                        </a>
                        <a href="./delete-customer.php?id=<?php echo $each['ID'] ?>" title="Xóa" class="staff__body-table-link">
